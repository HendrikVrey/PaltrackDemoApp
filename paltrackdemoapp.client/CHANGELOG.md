...
- Create Angular project with ng: `ng new paltrackdemoapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`paltrackdemoapp.client.esproj`).
